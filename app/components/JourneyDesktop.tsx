...
type Props = {
  ...
  viewportEnterEnqueue: (entry: IntersectionObserverEntry | null, animationFunc: Function) => void
};

const JourneyDesktop: React.FC<Props> = ({
  journeyDict,
          ...
          return (
            ...
            >
              <motion.section
                ...
                style={{
                  background: `linear-gradient(${isOdd ? "to left" : "to right"
