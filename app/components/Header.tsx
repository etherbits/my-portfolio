...
const Header: React.FC<Props> = ({ navDict }) => {
  return (
    <header className="sticky top-0 grid z-1 grid-cols-[1fr_1fr] items-center justify-between bg-gradient-to-t from-[#00000099] to-[#000000ff] px-6 py-3 backdrop-blur-lg md:grid-cols-[1fr_auto_1fr] md:px-10 md:py-6">
      <MotionLink
        href="/"
        className={cn(
